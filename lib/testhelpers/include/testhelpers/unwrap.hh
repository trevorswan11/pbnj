...
#define UNWRAP(expr) ::pbnj::tests::helpers::unwrap((expr), #expr, __FILE__, __LINE__)
...
#define UNWRAP_ERR(expr) ::pbnj::tests::helpers::unwrap_err((expr), #expr, __FILE__, __LINE__)
